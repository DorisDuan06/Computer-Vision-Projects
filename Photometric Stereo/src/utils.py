...
def enforceIntegrability(N, s, sig = 3):
    ...
    Find a transform Q that makes the pseudonormals integrable and transform them
    by it

    Parameters
    ----------
    N : numpy.ndarray
        The 3 x P matrix of (possibly) non-integrable pseudonormals
    ...
    -------
    Nt : numpy.ndarray
        The 3 x P matrix of transformed, integrable pseudonormals
    """
